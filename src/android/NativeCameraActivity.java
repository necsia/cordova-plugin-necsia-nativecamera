...
package es.necsia.nativecamera;
...
public class NativeCameraActivity extends Activity implements SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        Log.d(TAG, "Native Camera Activity Started!");
...
//                            "Error taking picture3", Toast.LENGTH_SHORT).show();
    ...
    private float pxFromDp(float dp) {
        return dp * NativeCameraActivity.this.getResources().getDisplayMetrics().density;
    }
